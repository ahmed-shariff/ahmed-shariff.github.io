...
<article class="p-5 md:p-0 prose mx-auto max-w-(--breakpoint-xl) prose-img:block prose-img:m-auto prose-img:max-h-96 prose-p:w-full prose-h1:text-left wrap-break-word prose-table:table-auto prose-table:bg-slate-900 prose-td:border prose-td:border-slate-600 prose-td:p-2">
